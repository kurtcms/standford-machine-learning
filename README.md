...
![alt text](https://kurtcms.org/standford-machine-learning/ex1_profit-vs-population-size-linear-regression.png)

Surface and contour plots of the cost function J(&theta;): 

![alt text](https://kurtcms.org/standford-machine-learning/ex1_cost-function-surface-plot.png)![alt text](https://kurtcms.org/standford-machine-learning/ex1_cost-function-contour-plot.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex1_multi_gradient-decent-convergence.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex2_exam-scores-vs-university-admission-decision-boundary.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex2_reg-microchip-test-results-vs-qa-decision-boundary.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex2_reg-microchip-test-results-vs-qa-decision-boundary-lambda-0.png)
![alt text](https://kurtcms.org/standford-machine-learning/ex2_reg-microchip-test-results-vs-qa-decision-boundary-lambda-100.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex3_hand-written-digits.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex4_hand-written-digits.png)
![alt text](https://kurtcms.org/standford-machine-learning/ex4_hand-written-digits-representation-hidden-layer.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex5_reservoir-water-level-change-vs-water-outflow-linear-regression.png)![alt text](https://kurtcms.org/standford-machine-learning/ex5_training-cross-validation-error-vs-training-set-size-linear-regression.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex5_reservoir-water-level-change-vs-water-outflow-polynomial-regression-lambda-1.png)![alt text](https://kurtcms.org/standford-machine-learning/ex5_training-cross-validation-error-vs-training-set-size-polynomial-regression-lambda-1.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex5_reservoir-water-level-change-vs-water-outflow-polynomial-regression-lambda-0.png)![alt text](https://kurtcms.org/standford-machine-learning/ex5_training-cross-validation-error-vs-training-set-size-polynomial-regression-lambda-0.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex5_reservoir-water-level-change-vs-water-outflow-polynomial-regression-lambda-100.png)![alt text](https://kurtcms.org/standford-machine-learning/ex5_training-cross-validation-error-vs-training-set-size-polynomial-regression-lambda-100.png)

Training and cross-validation error as a function of the regularisation parameter (&lambda;). 

![alt text](https://kurtcms.org/standford-machine-learning/ex5_training-cross-validation-error-vs-lambda.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex6_example-dataset-1-linear-decison-boundary-c-1.png)![alt text](https://kurtcms.org/standford-machine-learning/ex6_example-dataset-1-linear-decison-boundary-c-100.png)

SVM non-linear decision boundary with a Gaussian kernel on example dataset #2: 

![alt text](https://kurtcms.org/standford-machine-learning/ex6_example-dataset-2-non-linear-decison-boundary-gaussian-kernel.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex6_example-dataset-3-non-linear-decison-boundary-gaussian-kernel-c-min-error.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex7_example-dataset-k-means-iteration-1.png)![alt text](https://kurtcms.org/standford-machine-learning/ex7_example-dataset-k-means-iteration-10.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex7_bird-image-compression-k-means-16-colours.png)

Each pixel of the bird image, plotted with RGB values on a different axis each, grouped in 16 principal colour clusters: 

![alt text](https://kurtcms.org/standford-machine-learning/ex7_bird-image-compression-k-means-16-colours-pixel-plot-3d.png)![alt text](https://kurtcms.org/standford-machine-learning/ex7_bird-image-compression-k-means-16-colours-pixel-plot-2d.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex7_pca-example-dataset-eigenvectors.png)![alt text](https://kurtcms.org/standford-machine-learning/ex7_pca-example-dataset-dimensionality-reduction-principal-component-analysis.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex7_pca-face-image-compression-dimensionality-reduction-principal-component-analysis.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex8_anomalies-detection-gaussian-distribution.png)
...
![alt text](https://kurtcms.org/standford-machine-learning/ex8_movielens-100k-movies-vs-users.png)
